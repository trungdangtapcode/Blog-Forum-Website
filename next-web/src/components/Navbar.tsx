	...
	style={{height: `${NAVBAR_HEIGHT}px`}}>
		<div className='flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white'>
			...
			isLoggedIn ? (
				...
				<Button className="text-white bg-transparent border border-white hover:text-primary-800 hover:bg-white rounded-lg cursor-pointer">
					Profile
				</Button>
				</Link>
				<Link href="/auth/logout">
				<Button className="text-white bg-secondary-600 hover:text-primary-800 hover:bg-white rounded-lg cursor-pointer">
					Log out
				</Button>
				</Link>
				</div>
